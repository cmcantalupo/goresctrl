...
type Reading struct {
	...
	Unit   string      // unit hint, e.g. "bytes", "joules", "farads"
}
...
var readingMeta = map[string]struct {
	...
	"llc_occupancy":    {Gauge, "bytes"},
	"mbm_total_bytes":  {Cumulative, "bytes"},
	"mbm_local_bytes":  {Cumulative, "bytes"},
	"core_energy":      {Cumulative, "joules"},
