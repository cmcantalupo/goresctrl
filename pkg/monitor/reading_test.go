...
func TestSnapshot_ReturnsGroupHandles(t *testing.T) {
	...
	mgr.entries["pod-a"] = &entry{dir: dir1, members: make(map[string]struct{})}
	mgr.entries["pod-b"] = &entry{dir: dir2, members: make(map[string]struct{})}
...
func TestSnapshot_IsolatedFromManager(t *testing.T) {
	...
	mgr.entries["pod-x"] = &entry{dir: dir1, members: make(map[string]struct{})}
